...
from io import StringIO                      # want to store processed data to csv data
import pandas as pd
def album(data):
...
def lambda_handler(event, context):
    ...
    s3 = boto3.client('s3')
    Bucket='spotify-etl-project-ankita'
    ...
    for data in spotify_data:
        ...
        # After Transformation we need to store it to album,artist,song folder of 'transformed_data' folder
